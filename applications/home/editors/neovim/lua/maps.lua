...
map("n", "<leader>fk", "<cmd>Telescope keymaps<CR>", { desc = "List all keymaps" })
map("v", "<leader>fk", "<cmd>Telescope keymaps<CR>", { desc = "List all keymaps" })
map("n", "<leader>bl", "<cmd>Telescope buffers<CR>", { desc = "List all buffers" })

map("n", "<C-S>", "<cmd>SaveSession<CR>", { desc = "Save the current session" })
