...
in {
  programs.neovim.plugins =
    [ # Plugins that are not in the standard nix repository
      ...
      (mkPlugin "narutoxy/silicon.lua" { })
      (mkPlugin "ckolkey/ts-node-action" { ref = "master"; })
      (mkPlugin "mrjones2014/nvim-ts-rainbow" { ref = "master"; })
